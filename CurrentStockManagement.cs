...
namespace RangaHardwareStock
{
    ...
    public partial class CurrentStockManagementForm : Form
    {
        ...
        private void CurrentStockManagementForm_Load(object sender, EventArgs e)
        {
            ...
            //fill data view
            SqlDataAdapter sda = new SqlDataAdapter(@"SELECT i.Item_ID,i.Item_Name,l.Value AS Stock_Status,i.Current_Stock,i.Mesuring_Unit,i.Unit_Price,s.Name FROM Item i , Supplier s , StockLevel l
